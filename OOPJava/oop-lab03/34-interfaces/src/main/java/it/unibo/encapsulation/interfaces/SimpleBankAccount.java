...
public class SimpleBankAccount implements BankAccount {
    ...
    /*
     * Creare un costruttore pubblico che prenda in ingresso un intero
     * (ossia l'id dell'utente) ed un double (ossia, l'ammontare iniziale del
     * conto corrente).
     */
    public SimpleBankAccount(final int id, AccountHolder accountHolder){
